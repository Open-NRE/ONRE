...
mainClass in assembly := Some("edu.knowitall.openie.OpenIECli") //TODO
...
licenses := Seq("Open IE Software License Agreement" -> url("https://raw.github.com/knowitall/openie/master/LICENSE"))  //TODO

homepage := Some(url("https://github.com/knowitall/openie")) //TODO
...
pomExtra := (
  <scm>
    ...
    <connection>scm:git://github.com/knowitall/openie.git</connection> //TODO
    <developerConnection>scm:git:git@github.com:knowitall/openie.git</developerConnection> //TODO
    <tag>HEAD</tag>
  </scm>
  <developers>
   <developer>
